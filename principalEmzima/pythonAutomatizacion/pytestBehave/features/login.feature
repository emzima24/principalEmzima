Feature: Go to on test page on login
  ...
  Scenario Outline: Login test in ulr
    ...
    Examples:
      ...
      | https://practicetestautomation.com/practice-test-login/ | student  | [blanck]    | Your password is invalid!                            |
      | https://practicetestautomation.com/practice-test-login/ | st       | Password123 | Your username is invalid!                            |
      | https://practicetestautomation.com/practice-test-login/ | [blanck] | Password123 | Your username is invalid!                            |
      | https://practicetestautomation.com/practice-test-login/ | [blanck] | [blanck]    | Your username is invalid!                            |
