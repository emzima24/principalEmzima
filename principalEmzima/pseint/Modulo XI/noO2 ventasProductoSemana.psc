...
// estad�stica de las ventas de cada uno de sus productos a lo largo de una 
// semana, distribuyendo los 5 productos en los 5 d�as h�biles. Se desea conocer:
//		* El total de ventas por cada d�a de la semana.
//	 	* El total de ventas de cada producto a lo largo de la semana.
//		* El producto m�s vendido en cada semana.
//		* El nombre, el d�a de la semana y la cantidad del producto m�s vendido.
// El informe final tendr� el siguiente formato:
