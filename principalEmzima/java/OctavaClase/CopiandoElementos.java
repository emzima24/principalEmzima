...
public class CopiandoElementos {
    public static void main(String[] args) {
        ...
        try (Scanner input = new Scanner(System.in)) {
            ...
            System.out.println("El " + arrayText[count] + " elemento del arreglo, un número entero [" + count + "] es "
                    + arrayInt[count]);
            ...
            System.out.println("*********************************************************************");
            System.out
                    .print("Ingresa un número entero que será el " + arrayText[count] + " elemento del nuevo arreglo ");
            ...
            System.out.println(
                    "**********************************************************************************************");
            System.out.println("El " + arrayText[count] + " elemento del nuevo arreglo, arreglo de números enteros, ["
                    + count + "] es " + arrayIntCopy[count++]);
            System.out.println("El " + arrayText[count] + " elemento del nuevo arreglo, arreglo de números enteros, ["
                    + count + "] es " + arrayIntCopy[count++]);
            System.out.println("El " + arrayText[count] + " elemento del nuevo arreglo, arreglo de números enteros, ["
                    + count + "] es " + arrayIntCopy[count++]);
