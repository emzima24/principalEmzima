...
public class EmulatorTest extends BaseTest {
    ...
    public void setUp() throws Exception {
        System.out.println("[DEBUG] Configurando sesión para Emulador Pixel_7");
        setupDriver("Pixel_7", "emulator-5554"); // Nombre del emulador (ver en AVD Manager)
    }

    @Test
    @Order(1)
    public void testLoginOnEmulator() {
        try {
            ...
            takeScreenshot("testLoginOnEmulator", "success_message_emulator");
            ...
            System.out.println("[DEBUG] Login exitoso en emulador");
        } catch (Exception e) {
    ...
    public void testFormsOnMobileMygalaxy() {
        ...
        try {
            ...
            takeScreenshot("testformOnEmulator", "message_emulator");
            ...
            takeScreenshot("testformOnEmulator", "switch_change");
            ...
            takeScreenshot("testformOnEmulator", "selection_dropdown_emulator");
            ...
            takeScreenshot("testformOnEmulator", "home_emulator");
